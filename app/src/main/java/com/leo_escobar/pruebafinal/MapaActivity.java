    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        actualLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(MapaActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    mFusedLocationClient.getLastLocation().addOnSuccessListener(MapaActivity.this, new OnSuccessListener<Location>() {
                        @Override
                    ...
                    ActivityCompat.requestPermissions(MapaActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
                }
            }
        });
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MapaActivity.this, CrearCliente.class);
                ...
                if (error == OnEngineInitListener.Error.NONE) {
                    ...
                    mapFragment.getMapGesture().addOnGestureListener(new MapGesture.OnGestureListener(){
                        ...
                        public boolean onTapEvent(PointF pointF) {
                            ...
                            if(m_tapMarker ==null){
                                ...
                                //obtener direccion
                                Geocoder geocoder = new Geocoder(MapaActivity.this, Locale.getDefault());
                    ...
                    runOnUiThread(new Runnable() {
                        @Override public void run() {
                            new AlertDialog.Builder(MapaActivity.this).setMessage(
                                            "Error : " + error.name() + "\n\n" + error.getDetails())
